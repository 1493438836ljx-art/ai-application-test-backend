...
CREATE TABLE IF NOT EXISTS workflow (
    ...
    trigger_type VARCHAR(20) DEFAULT NULL COMMENT '触发类型：MANUAL/SCHEDULE/API',
    trigger_config TEXT DEFAULT NULL COMMENT '触发配置（JSON格式）',
...
CREATE TABLE IF NOT EXISTS workflow_node (
    ...
    node_uuid VARCHAR(36) NOT NULL COMMENT '节点UUID(标准UUID格式)',
